...
class ProdSettingsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ...
            ['setting_name'     => 'purchase_invoice_prefix',      'setting_value'   => ''],
            ['setting_name'     => 'purchase_invoice_suffix',      'setting_value'   => ''],
            ['setting_name'     => 'purchase_last_invoice_number', 'setting_value'   => 1],
            ['setting_name'     => 'purchase_auto_generate_invoice','setting_value'   => 0],
            ['setting_name'     => 'purchase_invoice_starts_from', 'setting_value'   => 1],
            ...
            ['setting_name'     => 'purchase_code',                 'setting_value'   =>  env('PURCHASED_CODE')],
        ]);
    }
}